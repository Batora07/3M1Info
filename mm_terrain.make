...
ifeq ($(config),debug64)
  OBJDIR     = obj/x64/debug/mm_terrain
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/mm_terrain
  DEFINES   += -DDEBUG
...
ifeq ($(config),release64)
  OBJDIR     = obj/x64/release/mm_terrain
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/mm_terrain
  DEFINES   +=
  INCLUDES  += -I.. -I../src/gKit
...
ifeq ($(config),debug32)
  OBJDIR     = obj/x32/debug/mm_terrain
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/mm_terrain
  DEFINES   += -DDEBUG
  INCLUDES  += -I.. -I../src/gKit
...
ifeq ($(config),release32)
  OBJDIR     = obj/x32/release/mm_terrain
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/mm_terrain
  DEFINES   +=
  INCLUDES  += -I.. -I../src/gKit
...
$(OBJDIR)/mm_terrain.o: mm_terrain.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF $(@:%.o=%.d) -c "$<"
